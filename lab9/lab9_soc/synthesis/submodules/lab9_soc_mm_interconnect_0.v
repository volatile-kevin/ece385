...
module lab9_soc_mm_interconnect_0 (
	...
	wire          aes_aes_slave_agent_rdata_fifo_src_valid;                                           // AES_AES_slave_agent:rdata_fifo_src_valid -> AES_AES_slave_agent_rdata_fifo:in_valid
	wire   [33:0] aes_aes_slave_agent_rdata_fifo_src_data;                                            // AES_AES_slave_agent:rdata_fifo_src_data -> AES_AES_slave_agent_rdata_fifo:in_data
	wire          aes_aes_slave_agent_rdata_fifo_src_ready;                                           // AES_AES_slave_agent_rdata_fifo:in_ready -> AES_AES_slave_agent:rdata_fifo_src_ready
	...
	wire          aes_aes_slave_agent_rdata_fifo_out_valid;                                           // AES_AES_slave_agent_rdata_fifo:out_valid -> avalon_st_adapter:in_0_valid
	wire   [33:0] aes_aes_slave_agent_rdata_fifo_out_data;                                            // AES_AES_slave_agent_rdata_fifo:out_data -> avalon_st_adapter:in_0_data
	wire          aes_aes_slave_agent_rdata_fifo_out_ready;                                           // avalon_st_adapter:in_0_ready -> AES_AES_slave_agent_rdata_fifo:out_ready
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) aes_aes_slave_agent_rdata_fifo (
		.clk               (clk_0_clk_clk),                            //       clk.clk
		.reset             (AES_RESET_reset_bridge_in_reset_reset),    // clk_reset.reset
		.in_data           (aes_aes_slave_agent_rdata_fifo_src_data),  //        in.data
		.in_valid          (aes_aes_slave_agent_rdata_fifo_src_valid), //          .valid
		.in_ready          (aes_aes_slave_agent_rdata_fifo_src_ready), //          .ready
		.out_data          (aes_aes_slave_agent_rdata_fifo_out_data),  //       out.data
		.out_valid         (aes_aes_slave_agent_rdata_fifo_out_valid), //          .valid
		.out_ready         (aes_aes_slave_agent_rdata_fifo_out_ready), //          .ready
		.csr_address       (2'b00),                                    // (terminated)
		.csr_read          (1'b0),                                     // (terminated)
		.csr_write         (1'b0),                                     // (terminated)
		.csr_readdata      (),                                         // (terminated)
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.out_reset         (AES_RESET_reset_bridge_in_reset_reset),          // out_clk_reset.reset
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.in_reset          (AES_RESET_reset_bridge_in_reset_reset),          //  in_clk_reset.reset
	...
	lab9_soc_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_0_data      (aes_aes_slave_agent_rdata_fifo_out_data),  //     in_0.data
		.in_0_valid     (aes_aes_slave_agent_rdata_fifo_out_valid), //         .valid
		.in_0_ready     (aes_aes_slave_agent_rdata_fifo_out_ready), //         .ready
